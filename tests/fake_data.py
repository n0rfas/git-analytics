...
FAKE_COMMITS = [
    AnalyticsCommit(
        ...
        commit_author="Bob",
        committed_datetime=datetime(2024, 1, 7, 11, 45, 4, tzinfo=timezone(timedelta(days=-1, seconds=79200))),
    ...
    AnalyticsCommit(
        ...
        commit_author="Bob",
        committed_datetime=datetime(2024, 1, 7, 18, 35, 7, tzinfo=timezone(timedelta(days=-1, seconds=79200))),
    ...
    AnalyticsCommit(
        ...
        commit_author="Bob",
        committed_datetime=datetime(2024, 1, 5, 18, 15, 37, tzinfo=timezone(timedelta(days=-1, seconds=79200))),
    ...
    AnalyticsCommit(
        ...
        commit_author="Alice",
        committed_datetime=datetime(2024, 1, 5, 18, 5, 5, tzinfo=timezone(timedelta(seconds=7200))),
    ...
    AnalyticsCommit(
        ...
        commit_author="Alice",
        committed_datetime=datetime(2024, 1, 5, 15, 15, 59, tzinfo=timezone(timedelta(seconds=7200))),
    ...
    AnalyticsCommit(
        ...
        commit_author="Dave",
        committed_datetime=datetime(2024, 1, 5, 14, 40, 28, tzinfo=timezone(timedelta(seconds=7200))),
    ...
    AnalyticsCommit(
        ...
        commit_author="Alice",
        committed_datetime=datetime(2024, 1, 4, 14, 35, 1, tzinfo=timezone(timedelta(seconds=7200))),
    ...
    AnalyticsCommit(
        ...
        commit_author="Dave",
        committed_datetime=datetime(2024, 1, 4, 14, 5, 6, tzinfo=timezone(timedelta(seconds=7200))),
    ...
    AnalyticsCommit(
        ...
        commit_author="Oscar",
        committed_datetime=datetime(2024, 1, 3, 13, 30, 44, tzinfo=timezone(timedelta(days=-1, seconds=79200))),
    ...
    AnalyticsCommit(
        ...
        commit_author="Carol",
        committed_datetime=datetime(2024, 1, 3, 12, 40, 8, tzinfo=timezone.utc),
    ...
    AnalyticsCommit(
        ...
        commit_author="Oscar",
        committed_datetime=datetime(2024, 1, 3, 12, 20, 13, tzinfo=timezone(timedelta(days=-1, seconds=79200))),
    ...
    AnalyticsCommit(
        ...
        commit_author="Alice",
        committed_datetime=datetime(2024, 1, 3, 12, 10, 23, tzinfo=timezone(timedelta(seconds=7200))),
    ...
    AnalyticsCommit(
        ...
        commit_author="Alice",
        committed_datetime=datetime(2024, 1, 3, 11, 10, 42, tzinfo=timezone(timedelta(seconds=7200))),
    ...
    AnalyticsCommit(
        ...
        commit_author="Dave",
        committed_datetime=datetime(2024, 1, 3, 11, 0, 25, tzinfo=timezone(timedelta(seconds=7200))),
    ...
    AnalyticsCommit(
        ...
        commit_author="Dave",
        committed_datetime=datetime(2024, 1, 3, 10, 35, 51, tzinfo=timezone(timedelta(seconds=7200))),
        lines_insertions=35,
        lines_deletions=6,
        files_changed=9,
    ...
    AnalyticsCommit(
        ...
        commit_author="Carol",
        committed_datetime=datetime(2024, 1, 3, 10, 0, 55, tzinfo=timezone.utc),
    ...
    AnalyticsCommit(
        ...
        commit_author="Oscar",
        committed_datetime=datetime(2024, 1, 3, 9, 10, 24, tzinfo=timezone(timedelta(days=-1, seconds=79200))),
    ...
    AnalyticsCommit(
        ...
        commit_author="Oscar",
        committed_datetime=datetime(2024, 1, 3, 9, 0, 37, tzinfo=timezone(timedelta(days=-1, seconds=79200))),
    ...
    AnalyticsCommit(
        ...
        commit_author="Dave",
        committed_datetime=datetime(2024, 1, 3, 8, 5, 59, tzinfo=timezone(timedelta(seconds=7200))),
        lines_insertions=52,
        lines_deletions=52,
        files_changed=4,
        message="ci: cache pip and node modules",
    ...
    AnalyticsCommit(
        ...
        commit_author="Alice",
        committed_datetime=datetime(2024, 1, 2, 20, 30, 21, tzinfo=timezone(timedelta(seconds=7200))),
    ...
    AnalyticsCommit(
        ...
        commit_author="Dave",
        committed_datetime=datetime(2024, 1, 2, 20, 25, 14, tzinfo=timezone(timedelta(seconds=7200))),
    ...
    AnalyticsCommit(
        ...
        commit_author="Dave",
        committed_datetime=datetime(2024, 1, 2, 20, 20, 4, tzinfo=timezone(timedelta(seconds=7200))),
    ...
    AnalyticsCommit(
        ...
        commit_author="Alice",
        committed_datetime=datetime(2024, 1, 2, 19, 55, 57, tzinfo=timezone(timedelta(seconds=7200))),
    ...
    AnalyticsCommit(
        ...
        commit_author="Oscar",
        committed_datetime=datetime(2024, 1, 2, 19, 55, 7, tzinfo=timezone(timedelta(days=-1, seconds=79200))),
    ...
    AnalyticsCommit(
        ...
        commit_author="Carol",
        committed_datetime=datetime(2024, 1, 2, 18, 50, 10, tzinfo=timezone.utc),
    ...
    AnalyticsCommit(
        ...
        commit_author="Bob",
        committed_datetime=datetime(2024, 1, 2, 17, 40, 7, tzinfo=timezone(timedelta(days=-1, seconds=79200))),
    ...
    AnalyticsCommit(
        ...
        commit_author="Oscar",
        committed_datetime=datetime(2024, 1, 2, 17, 10, 32, tzinfo=timezone(timedelta(days=-1, seconds=79200))),
    ...
    AnalyticsCommit(
        ...
        commit_author="Dave",
        committed_datetime=datetime(2024, 1, 2, 16, 10, 15, tzinfo=timezone(timedelta(seconds=7200))),
    ...
    AnalyticsCommit(
        ...
        commit_author="Dave",
        committed_datetime=datetime(2024, 1, 2, 15, 50, 20, tzinfo=timezone(timedelta(seconds=7200))),
        lines_insertions=68,
        lines_deletions=105,
        files_changed=1,
        message="deploy: staging workflow with tags",
    ...
    AnalyticsCommit(
        ...
        commit_author="Oscar",
        committed_datetime=datetime(2024, 1, 2, 15, 45, 29, tzinfo=timezone(timedelta(days=-1, seconds=79200))),
    ...
    AnalyticsCommit(
        ...
        commit_author="Bob",
        committed_datetime=datetime(2024, 1, 2, 15, 45, 12, tzinfo=timezone(timedelta(days=-1, seconds=79200))),
    ...
    AnalyticsCommit(
        ...
        commit_author="Alice",
        committed_datetime=datetime(2024, 1, 2, 15, 15, 28, tzinfo=timezone(timedelta(seconds=7200))),
    ...
    AnalyticsCommit(
        ...
        commit_author="Dave",
        committed_datetime=datetime(2024, 1, 2, 14, 50, 31, tzinfo=timezone(timedelta(seconds=7200))),
    ...
    AnalyticsCommit(
        ...
        commit_author="Carol",
        committed_datetime=datetime(2024, 1, 2, 14, 25, 13, tzinfo=timezone.utc),
    ...
    AnalyticsCommit(
        ...
        commit_author="Alice",
        committed_datetime=datetime(2024, 1, 2, 12, 15, 32, tzinfo=timezone(timedelta(seconds=7200))),
        lines_insertions=47,
        lines_deletions=292,
        files_changed=10,
        message="perf(ui): defer non-critical scripts",
    ...
    AnalyticsCommit(
        ...
        commit_author="Bob",
        committed_datetime=datetime(2024, 1, 2, 11, 15, 55, tzinfo=timezone(timedelta(days=-1, seconds=79200))),
    ...
    AnalyticsCommit(
        ...
        commit_author="Dave",
        committed_datetime=datetime(2024, 1, 2, 11, 10, 40, tzinfo=timezone(timedelta(seconds=7200))),
    ...
    AnalyticsCommit(
        ...
        commit_author="Oscar",
        committed_datetime=datetime(2024, 1, 2, 10, 20, 27, tzinfo=timezone(timedelta(days=-1, seconds=79200))),
    ...
    AnalyticsCommit(
        ...
        commit_author="Alice",
        committed_datetime=datetime(2024, 1, 2, 10, 5, 24, tzinfo=timezone(timedelta(seconds=7200))),
    ...
    AnalyticsCommit(
        ...
        commit_author="Alice",
        committed_datetime=datetime(2024, 1, 2, 10, 0, 47, tzinfo=timezone(timedelta(seconds=7200))),
